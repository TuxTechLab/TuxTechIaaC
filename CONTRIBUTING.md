...
Before submitting a new issue or PR, check if it already exists in the [Issues](https://github.com/tuxtechlab/tuxtechiaac/issues) or [Pull Requests](https://github.com/tuxtechlab/tuxtechiaac/pulls).
...
<table>
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/tuxtechlab/tuxtechiaac/issues?q=is:issue+is:open+sort:updated-desc+label:%22Low+priority%22">
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/tuxtechlab/tuxtechiaac/issues?q=is:issue+is:open+sort:updated-desc+label:%22Medium+priority%22">
  ...
  <tr>
    <td>Core Features</td>
    <td>
      <a href="https://github.com/tuxtechlab/tuxtechiaac/issues?q=is:issue+is:open+sort:updated-desc+label:%22High+priority%22">
  ...
  <tr>
    <td>Core Bugs</td>
    <td>
      <a href="https://github.com/tuxtechlab/tuxtechiaac/issues?q=is:issue+is:open+sort:updated-desc+label:Urgent">
...
- If the repository is backed by a specific technology (e.g. Python), prefix the filename and class name with it.
...
- Keep naming specific — avoid generic names like AppService.xxx.
...
[See README](https://github.com/tuxtechlab/tuxtechiaac#development)

## Building

Kindly follow the [Build.md](./Build.md) file for building the project.
...
[End-to-End Testing](https://github.com/tuxtechlab/tuxtechiaac#e2e-testing) is mentioned in the README, kindly follow it.
